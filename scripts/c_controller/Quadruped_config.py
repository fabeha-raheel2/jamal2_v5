...
# Min, Max and offset values in degrees 
MOTOR_MIN_MAX_OFFSET_MULT = {'lf_hip_joint':(-25, 25, 0, -1), 'lf_upper_leg_joint':(-20, 90, 45, -1), 'lf_lower_leg_joint':(-153, -47, -90, 0.88),
                             'rf_hip_joint':(-25, 25, 0, -1), 'rf_upper_leg_joint':(-20, 90, 45, 1), 'rf_lower_leg_joint':(-153, -47, -90, -0.88),
                             'lh_hip_joint':(-25, 25, 0, 1), 'lh_upper_leg_joint':(-81, 20, -45, -1), 'lh_lower_leg_joint':(47, 153, 90, 0.88),
                             'rh_hip_joint':(-25, 25, 0, 1), 'rh_upper_leg_joint':(-90, 20, -45, 1), 'rh_lower_leg_joint':(47, 153, 90, -0.88)
                             }
