...
MOTOR_MIN_MAX_OFFSET_MULT  = {
    '8':(-25, 25, -7, -1), '0':(-90, 110, -64,  1), '1':(48, 132, 48, 0.88),   # Left Front: Hip Abduction/Adduction, Hip Flexion/Extension, Knee Flexion/Extension
    '9':(-25, 25, -7,  1), '2':(-90, 110, -64,  1), '3':(48, 132, 48, 0.88),    # Left Hind
    '10':(-25, 25,  7, -1), '4':(-90, 110, -64, -1), '5':(48, 132, 48, -0.88),   # Right Front
    '11':(-25, 25,  7,  1), '6':(-90, 110, -64, -1), '7':(48, 132, 48, -0.88)   # Right Hind
             }
